...
const renderRole = (role) => {
  switch (role) {
    case 1:
      return <Tag color='blue' shape='circle'>普通用户</Tag>;
    case 10:
      return <Tag color='yellow' shape='circle'>管理员</Tag>;
    case 100:
      return <Tag color='orange' shape='circle'>超级管理员</Tag>;
    default:
      return <Tag color='red' shape='circle'>未知身份</Tag>;
  }
};
...
const renderStatus = (record) => {
  ...
  const tooltipContent = (
    <div className='text-xs'>
      <div>调用次数: {renderNumber(record.request_count)}</div>
    </div>
  );
  return (
