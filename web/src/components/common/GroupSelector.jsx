...
/**
 * Multi-group selector with drag-to-reorder priority.
 *
 * Props:
 *   groups       - array of { value, label, ratio } (available groups)
 *   tokenGroups  - array of { group, priority } (selected, ordered)
 *   setTokenGroups - setter for tokenGroups
 */
