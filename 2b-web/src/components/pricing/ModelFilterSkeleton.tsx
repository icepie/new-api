      ...
      <div className="pricing-filter-container">
        ...
        <div className="pricing-filter-header">
          <div className="pricing-filter-header-top">
            <div className="pricing-filter-header-content">
              <div className="skeleton-element" style={{ width: 100, height: 18 }} />
            </div>
            <div className="skeleton-element" style={{ width: 24, height: 24, borderRadius: 6 }} />
          </div>
        </div>
        ...
        <div className="pricing-filter-section">
          <div className="pricing-filter-section-header">
            <div className="skeleton-element" style={{ width: 60, height: 16 }} />
            <div className="skeleton-element" style={{ width: 16, height: 16, borderRadius: 2 }} />
          </div>
          <div className="pricing-filter-options">
            {Array.from({ length: 6 }).map((_, index) => (
              <div
                ...
                style={{ width: `${70 + (index % 3) * 15}px`, height: 32, borderRadius: 6 }}
              />
            ))}
          </div>
        </div>
        ...
        <div className="pricing-filter-section">
          <div className="pricing-filter-section-header">
            <div className="skeleton-element" style={{ width: 50, height: 16 }} />
            <div className="skeleton-element" style={{ width: 16, height: 16, borderRadius: 2 }} />
          </div>
        ...
        <div className="pricing-filter-section">
          <div className="pricing-filter-section-header">
            <div className="skeleton-element" style={{ width: 70, height: 16 }} />
            <div className="skeleton-element" style={{ width: 16, height: 16, borderRadius: 2 }} />
          </div>
          <div className="pricing-filter-options pricing-filter-options-single-column">
            {Array.from({ length: 6 }).map((_, index) => (
              <div key={index} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <div className="skeleton-element" style={{ width: 14, height: 14, borderRadius: 3 }} />
                <div
                  className="skeleton-element"
                  style={{ width: `${80 + (index % 3) * 20}px`, height: 16, flex: 1 }}
                />
              </div>
            ))}
          </div>
