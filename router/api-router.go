...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/oauth/wechat/qrcode", middleware.CriticalRateLimit(), controller.WeChatQRCodeLogin)
		apiRouter.POST("/oauth/wechat/qrcode/callback", controller.WeChatQRCallback)
		apiRouter.GET("/oauth/wechat/qrcode/status", middleware.CriticalRateLimit(), controller.WeChatQRStatus)
		apiRouter.POST("/oauth/wechat/qrcode/bind", middleware.CriticalRateLimit(), controller.WeChatQRBind)
